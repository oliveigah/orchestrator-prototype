...
const orchestratorTestRouteAdmin = require('./orchestrator-api/handlers/test-admin');
const orchestratorTestRouteApp = require('./orchestrator-api/handlers/test-app');
...
exports.orchestratorApp = () => {
  ...
  app.use('/admin/test', orchestratorTestRouteAdmin);
  app.use('/app/test', orchestratorTestRouteApp);
